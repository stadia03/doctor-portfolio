...
export default function ContactUs() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(
      "https://script.google.com/macros/s/AKfycbzuTpJqjsXEgdUZQNDHGI5Xt4VHxo6iCCeczGDitzIUCH1SRRSA7HJbUsqLUiWmkOs/exec",
      {
        method: "POST",
        body: formDatab
      }
      ...
      .then((data) => {
        setIsLoading(false);
        alert("Thank you for submitting your data. We'll be in touch shortly. Your patience is appreciated.");
        console.log(data);
      })
                  ...
                  <div className="row gy-4 gy-xl-5 p-4 p-xl-5">
                    ...
                    <div className="col-12">
                      <div className="d-grid">
                        <button className="btn btn-primary btn-lg" type="submit" onClick={handleSubmit} disabled={isLoading}>
                          {
